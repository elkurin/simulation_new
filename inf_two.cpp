...
namespace {
	ofstream take_log_type("data_twodesig3_type_number0_0.01.log");
	// ofstream take_log_network("data_equ1_network0_0.01.log");
	ofstream take_log_outside("data_twodesig3_outside0_0.01.log");
	...
	ofstream take_log_pop("data_twodesig3_pop.log");
	ofstream take_log_growth("data_twodesig3_growth");
}
