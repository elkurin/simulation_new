...
namespace {
	...
	ofstream take_log_type("data_evolve_large_type_number10_0.001.log");
	ofstream take_log_network("data_evolve_large_network10_0.001.log");
	ofstream take_log_outside("data_evolve_large_outside10_0.001.log");
	ofstream take_log_devdev("data_evolve_large_devdev10_0.001.log");
	ofstream take_log_coef("data_evolve_large_coef10_0.001.log");
	ofstream take_log_inside("data_evolve_large_inside10_0.001.log");
	ofstream take_log_go("data_evolve_large_go10_0.001.log");
}
...
void evolve(void)
{
	...
	rep(j, N) {
		...
		cell[cell_number].go[j] = rand() % 2;
		take_log_go << cell[cell_number].go[j] << " ";
	}
	take_log_go << endl;
...
void evolve_large(void)
{
	...
	rep(j, N) {
		begin_coef.at(cell_type).at(j) = 10 * keep.at(j) / sum;
	}
