...
namespace {
	ofstream take_log_type("data_start_type_number10_0.001.log");
	ofstream take_log_network("data_start_network10_0.001.log");
	ofstream take_log_outside("data_start_outside10_0.001.log");
	ofstream take_log_devdev("data_start_devdev10_0.001.log");
	ofstream take_log_coef("data_start_coef10_0.001.log");
	ofstream take_log_inside("data_start_inside10_0.001.log");
}
