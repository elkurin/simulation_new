...
namespace {
	ofstream take_log_type("data_outside_type_number10_0.001.log");
	ofstream take_log_network("data_outside_network10_0.001.log");
	ofstream take_log_outside("data_outside_outside10_0.001.log");
	ofstream take_log_devdev("data_outside_devdev10_0.001.log");
	ofstream take_log_coef("data_outside_coef10_0.001.log");
	ofstream take_log_inside("data_outside_inside10_0.001.log");
}
