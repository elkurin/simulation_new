...
namespace {
	ofstream take_log_type("data_desig_type_number10_0.001.log");
	ofstream take_log_network("data_desig_network10_0.001.log");
	ofstream take_log_outside("data_desig_outside10_0.001.log");
	ofstream take_log_devdev("data_desig_devdev10_0.001.log");
	ofstream take_log_coef("data_desig_coef10_0.001.log");
	ofstream take_log_inside("data_desig_inside10_0.001.log");
}
