...
namespace {
	ofstream take_log_type("data_leak_type_number10_0.001.log");
	ofstream take_log_network("data_leak_network10_0.001.log");
	ofstream take_log_outside("data_leak_outside10_0.001.log");
	ofstream take_log_devdev("data_leak_devdev10_0.001.log");
	ofstream take_log_coef("data_leak_coef10_0.001.log");
	ofstream take_log_inside("data_leak_inside10_0.001.log");
}
