...
namespace {
	ofstream take_log_type("data_ignore_type_number.log");
	ofstream take_log_network("data_ignore_network.log");
	ofstream take_log_outside("data_ignore_outside.log");
	ofstream take_log_devdev("data_ignore_devdev.log");
	ofstream take_log_coef("data_ignore_coef.log");
	ofstream take_log_inside("data_ignore_inside.log");
}
