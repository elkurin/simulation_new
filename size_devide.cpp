...
namespace {
	ofstream take_log_type("data_devide_type_number10_0.001.log");
	ofstream take_log_network("data_devide_network10_0.001.log");
	ofstream take_log_outside("data_devide_outside10_0.001.log");
	ofstream take_log_devdev("data_devide_devdev10_0.001.log");
	ofstream take_log_coef("data_devide_coef10_0.001.log");
	ofstream take_log_inside("data_devide_inside10_0.001.log");
}
...
const double max_cell_size = 4.4;
double box_con;
