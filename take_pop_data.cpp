...
namespace {
	ofstream take_log_type("data_take_pop_type_number10.log");
	ofstream take_log_network("data_take_pop_network10.log");
	ofstream take_log_outside("data_take_pop_outside10.log");
	ofstream take_log_devdev("data_take_pop_devdev10.log");
	ofstream take_log_coef("data_take_pop_coef10.log");
	ofstream take_log_inside("data_take_pop_inside10.log");
	ofstream take_log_pop("data_take_pop_pop10.log");
}
...
void main_(void)
{
	...
	take_log_pop << aver_nut << " " << pop_sum / ((double)time_end * 0.8) << endl;
}
...
{
	rep(i, 20) {
		aver_nut = 0.001 + 0.00005 * i;
		main_();
	}
	rep(i, 10) {
		aver_nut = 0.002 + 0.0002 * i;
		main_();
	}
	return 0;
}
